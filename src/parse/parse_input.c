...
retorna 0 caso a conversão tenha falhado, caso contrário realiza a conversão e retorna 1 para verdadeiro
*/
...
/*
Verifica se o número de input já existe na stack, caso seja uma duplicada retorna 1 caso contrário retorna 0
*/
...
/*
Função principal de parse do input, caso o parse não execute corretamente retorna 0 
